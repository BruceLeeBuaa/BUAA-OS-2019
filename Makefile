...
objects           := $(boot_dir)/start.o                                                           $(init_dir)/main.o                                                        $(init_dir)/init.o                                                        $(init_dir)/code.o                                                        $(drivers_dir)/gxconsole/console.o                                  $(lib_dir)/*.o                                                            $(user_dir)/*.x                                  $(fs_dir)/*.x                                  $(mm_dir)/*.o
...
clean:
        for d in $(modules);                    do                                                              $(MAKE) --directory=$$d clean;                 done;         rm -rf *.o *~ $(vmlinux_elf)  $(user_disk)

...
static char *msg = "This is the NEW message of the day!rnrn";
static char *diff_msg = "This is a different massage of the day!rnrn";
...
void umain()
{
        ...
        writef("read again: OKn");

        if ((r = close(fdnum)) < 0) {
                user_panic("close /newmotd: %d", r);
        }
        writef("file rewrite is goodn");

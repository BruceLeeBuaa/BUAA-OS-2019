...
/*
 ...
 o                      +----------------------------+------------0xa000 0000
 o                      |      Invalid memory        |   /| o                      +----------------------------+----|-------Physics Memory Max
 o                      |       ...                  |  kseg0
 ...
 o      ULIM     -----> +----------------------------+------------0x8000 0000-------
 o                      |         User VPT           |     PDMAP                /| o      UVPT     -----> +----------------------------+------------0x7fc0 0000    |
 o                      |         PAGES              |     PDMAP                 |
...
#define TRUP(_p)                                                ({                                                                      register typeof((_p)) __m_p = (_p);                             (u_int) __m_p > ULIM ? (typeof(_p)) ULIM : __m_p;       })

...
#define ARGBEGIN        for((argv?0:(argv=(void*)&argc)),                            argv++,argc--;                            argv[0] && argv[0][0]=='-' && argv[0][1];                            argc--, argv++) {                                char *_args, *_argt;                                char _argc;                                _args = &argv[0][1];                                if(_args[0]=='-' && _args[1]==0){                                        argc--; argv++; break;                                }                                _argc = 0;                                while(*_args && (_argc = *_args++))                                switch(_argc)
